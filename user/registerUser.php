...
<?php
  if(isset($_POST['re_submit'])) {
    ...
    $res = mysqli_query($data, $checku);
    $count = mysqli_num_rows($res);
    if($count>0) {
      echo "Email already singed up";
    } else if($upass == '') {
        echo "password does not match";
    } else {
      $sql = "INSERT INTO `users`(`email`, `username`, `password`, `userType`, `status`) VALUES ('$uemail','$uname','$upass',1,0)";
            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                ...
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  ...
                  <img src="https://media.istockphoto.com/id/1146311489/photo/register-button-on-computer-keyboard.jpg?s=612x612&w=is&k=20&c=Hm2iAaE5fMIGY_pmqbBQ1ta0RMr8vSPmlUS9Fc8eamI=" class="img-fluid" alt="Sample image">
